...
use crate::application::use_cases::facility_management::FacilityManagementUseCase as FacilityUseCase;
use crate::domain::models::facilitie::Facility;
use actix_web::{Error, HttpResponse, web};

pub async fn get_all_facilities(
    use_case: web::Data<dyn FacilityUseCase>,
) -> Result<HttpResponse, Error> {
    let facilities = use_case.get_all().await.map_err(|e| {
...
pub async fn update_facility(
    ...
    match use_case.update(&facility_data).await {
