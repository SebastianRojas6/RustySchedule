use crate::application::use_cases::schedule_management::ScheduleManagementUseCase as ScheduleUseCase;
use crate::domain::{models::enums::Weekday, models::schedule::Schedule};
use actix_web::{Error, HttpResponse, web};

// Operaciones CRUD básicas
pub async fn get_all_schedules(
    use_case: web::Data<dyn ScheduleUseCase>,
) -> Result<HttpResponse, Error> {
    let schedules = use_case.get_all().await.map_err(|e| {
...
pub async fn update_schedule(
    ...
    match use_case.update(&schedule).await {
